...
$query="UPDATE users SET brave=brave+((maxbrave/5)+0.5) WHERE brave<maxbrave AND donatordays=0 ";
$query6="UPDATE users SET brave=brave+((maxbrave/2.5)+0.5) WHERE brave<maxbrave  AND donatordays>0 ";
