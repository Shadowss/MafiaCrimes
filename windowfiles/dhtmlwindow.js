...
init:function(t){
	...
	//this.zIndexvalue=(this.zIndexvalue)? this.zIndexvalue+1 : 150 //z-index value for DHTML window: starts at 0, increments whenever a window has focus
	...
	t.style.zIndex=150 //set z-index of this dhtml window
...
document.write('<div id="dhtmlwindowholder" style="position:relative;z-index:150;"><span style="display:none">.</span></div>') //container that holds all dhtml window divs on page
