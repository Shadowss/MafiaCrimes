...
/**************************************************************************************************
| Software Name        : CvTk Script Mafia Game
| Software Author      : CvTk Team
| Software Version     : Version 2.0.1 Build 2101
| Website              : http://www.mafiacrimes.net/
| E-mail               : support@mafiacrimes.net
|**************************************************************************************************
| The source files are subject to the CvTk Scripts End-User License Agreement included in License Agreement.html
| The files in the package must not be distributed in whole or significant part.
| All code is copyrighted unless otherwise advised.
| Do Not Remove Powered By CvTk Scripts without permission .         
|**************************************************************************************************
| Copyright (c) 2011 CvTk Scripts . All rights reserved.
|**************************************************************************************************/
...
<h1><img src="images/welcome_txt.gif" alt="" /></h1>
<p>Sign up to Mafia Crimes the best free mmorpg game today to become a mobster working your way through the ranks to become the greatest and most powerful gangster in the Mafioso world.. <br/><br/>You have the ability to be a leader and create your gang to drive to the top or can equally join gangs to help build an unstoppable empire. Collect cash, drugs and purchase weapons on the way of attacking your enemies to help build up respect.. Register if you think you have what it takes, remember...keep your friends close, but your enemies closer! </p>

</div>
<div class="column1_right">
<h1><a href='images/inventory.jpg' rel='lightbox[screen]' title='Game Screens'><img src="images/col1_img1.jpg" alt="" /></a></h1>
<h2 style="padding-top:20px;"><a href='images/gym_login.jpg' rel='lightbox[screen]' title='Game Screens'><img src="images/col1_img2.jpg" alt="" /></a></h2>                        
</div>
</div>                    
